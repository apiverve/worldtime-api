...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/worldtime";
        ...
        public WorldTimeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldTimeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldTimeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WorldTimeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WorldTimeQueryOptions options)
        {
        ...
        public ResponseObj Execute(WorldTimeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WorldTimeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WorldTimeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WorldTimeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WorldTimeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WorldTimeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WorldTimeQueryOptions options)
        {
