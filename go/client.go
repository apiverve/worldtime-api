// Package worldtime provides a Go client for the World Time API.
//
// For more information, visit: https://worldtime.apiverve.com?utm_source=go&utm_medium=readme
package worldtime
...
const (
	baseURL        = "https://api.apiverve.com/v1/worldtime"
	defaultTimeout = 30 * time.Second
)

// Client is the World Time API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new World Time API client.
...
// Execute makes a request to the World Time API with typed parameters.
//
...
//   - city (required): string - The city name for which you want to get the current time (e.g., New York)
