...
```gradle
dependencies {
    implementation 'com.github.apiverve:worldtime-api:1.1.14'
}
```
...
```java
import com.apiverve.worldtime.WorldTimeAPIClient;
import com.apiverve.worldtime.APIResponse;
import com.apiverve.worldtime.APIException;

// Initialize the client
WorldTimeAPIClient client = new WorldTimeAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("city", "San Francisco");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/worldtime](https://docs.apiverve.com/ref/worldtime)
...
- **Documentation:** [https://docs.apiverve.com/ref/worldtime](https://docs.apiverve.com/ref/worldtime)
- **Issues:** [GitHub Issues](https://github.com/apiverve/worldtime-api/issues)
